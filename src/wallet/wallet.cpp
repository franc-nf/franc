...
int CWalletTx::GetBlocksToMaturity() const
{
    ...
    //FRTODO Some wallets are still not abandoning coinstakes correctly
...
void CWallet::StakeFRs(bool fStake, CConnman* connman, CTxMemPool* mempool)
{
    ::StakeFRs(fStake, this, connman, mempool, stakeThread);
}

void CWallet::StartStake(CConnman *connman, CTxMemPool* mempool)
{
    m_enabled_staking = true;
    StakeFRs(true, connman, mempool);
}
