...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 FR from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 FR in block rewards plus fees, but
        ...
        # Send 10 FR with subtract fee from amount
        ...
        # Sendmany 10 FR with subtract fee from amount
